            ...
            <form class="col s12" method="post" action="{{ route('admin.menus.modification') }}">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input name="title" id="title" type="text" class="validate" value="!@!" required="" aria-required="true">
                        <label for="title">Title</label>
                    </div>
                    <div class="input-field col s12">
                        <input name="text" id="text" type="text" class="validate" value="!@!" required="" aria-required="true">
                        <label for="text">Text</label>
                    </div>
                    <div class="input-field col s12">
                        <input name="meta_title" id="meta_title" type="text" class="validate" value="!@!" required="" aria-required="true">
                        <label for="meta_title">Meta_title</label>
                    </div>
                    <div class="input-field col s12">
                        <input name="meta_description" id="meta_description" type="text" class="validate" value="!@!" required="" aria-required="true">
                    ...
                    <div class="input-field col s12">
                        <input name="number" id="number" type="number" class="validate" value="00" required="" aria-required="true">
    ...
    $(document).ready(function(){
        $('#changeMenuModal').modal({
            ready: function(modal, trigger) {
                ...
                modal.find('.modal-content #status').val(menu['status']);
